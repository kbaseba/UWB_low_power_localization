...
class SectorAssignment:
    def __init__(self, map_width, map_height, num_sectors, num_nodes, node_range, obstacles, threshold, duty_cycle, 
                 efficacy, motor_power_consum, velocity, ble_power_consum, uwb_power_consum, dt, Q, R):
    ...
    def update(self):
        ...
        hub = self.node_placement.update(sectors, self.threshold, self.duty_cycle, self.efficacy, self.motor_power_consum, 
                                         self.velocity, self.ble_power_consum, self.uwb_power_consum, self.dt, self.Q, self.R) 
