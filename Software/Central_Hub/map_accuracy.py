...
class MapAccuracy:
    ...
    def update(self):
        ...
        if num_collisions == 0:
            # Handle the zero division case (e.g., return 0% accuracy or a special value)
            return 0  # Adjust this value based on your desired behavior
