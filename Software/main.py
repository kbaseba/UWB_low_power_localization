...
def update_config(entries, config_file):
    try:
...
def start_simulation():
    #update_config(entries, config_file)
...
def create_gui(config_path):
    ...
    # Buttons
    tk.Button(root, text="Start", command=lambda: start_simulation()).grid(
